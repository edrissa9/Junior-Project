...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $billinginfo->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("BillingInfos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/billinginfos/'.$billinginfo->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("BillingInfos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.billinginfos.destroy', $billinginfo->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/billinginfos') }}" data-toggle="tooltip" data-placement="right" title="Back to BillingInfos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'zip_code')
						@la_display($module, 'phone')
						@la_display($module, 'mobile_phone')
						@la_display($module, 'fax')
						@la_display($module, 'shipping_order')
						@la_display($module, 'shipping_to_billing')
						@la_display($module, 'payment_method')
